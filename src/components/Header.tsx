        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            <button
              ...
              className="p-2 text-gray-700 hover:text-emerald-600 transition-colors rounded-full hover:bg-emerald-50"
            >
              <svg
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-white shadow-lg border-t border-gray-100 py-4 px-4 flex flex-col space-y-2">
          <Link
            to="/"
            onClick={closeMenu}
            className="text-gray-700 hover:text-emerald-600 hover:bg-emerald-50 px-4 py-3 rounded-lg transition-colors font-medium"
          >
            Início
          </Link>
          <Link
