...
describe('OrderManagement component', () => {
  it('should render loading state', () => {
    ...
    const { container } = render(<OrderManagement orders={[]} onConfirmOrder={vi.fn()} loading={true} />);
  ...
  it('should expand and show order details when clicked', () => {
    ...
    const orderHeader = screen.getByText('Maria Silva').closest('div[role="button"]') || screen.getByText('Maria Silva').parentElement;
  ...
  it('should call onConfirmOrder when confirm button is clicked', () => {
    ...
    render(<OrderManagement orders={[mockOrder]} onConfirmOrder={mockOnConfirm} />);
