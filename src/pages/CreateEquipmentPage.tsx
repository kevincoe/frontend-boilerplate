...
const EquipmentSchema = z.object({
  ...
  category: z.enum(['MOVEIS', 'DECORACAO', 'LOUÇAS', 'TECIDOS', 'ELETRONICOS', 'GERAL'], {
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">Cadastre um novo item no acervo e defina a quantidade física (estoque).</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="p-6 md:p-8 space-y-8">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 border-b border-gray-100 pb-2 mb-6">Informações Principais</h3>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="col-span-1 md:col-span-2">
                    <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-1">Nome do Equipamento *</label>
                  ...
                  <div className="col-span-1 md:col-span-2">
                    <label htmlFor="description" className="block text-sm font-medium text-gray-700 mb-1">Descrição do Produto</label>
                    <div className="relative">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 border-b border-gray-100 pb-2 mb-6">Valores e Quantidade física</h3>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="pricePerDay" className="block text-sm font-medium text-gray-700 mb-1">Preço da Diária (R$) *</label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    ...
                    {errors.pricePerDay && <p className="mt-1.5 text-sm text-red-600 font-medium">{errors.pricePerDay.message}</p>}
                  </div>

                  <div>
                    <label htmlFor="stock" className="block text-sm font-medium text-gray-700 mb-1">Unidades em Estoque *</label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    ...
                    <p className="mt-1 text-xs text-gray-500">Isso criará {`{N}`} sub-registros de ativos para rastreamento serializado.</p>
                    {errors.stock && <p className="mt-1.5 text-sm text-red-600 font-medium">{errors.stock.message}</p>}
                  </div>
                </div>
              </div>
            </div>
