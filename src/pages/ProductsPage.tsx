          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Gerencie seu acervo de equipamentos para locação
              </p>
            </div>
          </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-emerald-500 bg-white"
                    >
            ...
            <div className="bg-white rounded-xl shadow-xl w-full max-w-sm overflow-hidden flex flex-col">
              ...
              <form onSubmit={handleStockSubmit} className="p-6 space-y-4">
                <p className="text-sm text-gray-600">
                  Atualize a quantidade total de{" "}
                  <strong>{stockProduct.name}</strong>. Atualmente existem{" "}
                  {stockProduct.totalStock} peças.
                </p>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Novo Estoque Físico Total
                  </label>
                  <input
                    type="number"
                    min="0"
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-xl shadow-xl w-full max-w-sm overflow-hidden flex flex-col p-6 text-center">
              ...
              <p className="text-sm text-gray-500 mb-6">
                ...
                <strong>{deletingProduct.name}</strong>? Esta ação removerá o
                produto e todos os seus registros de estoque permanentemente.
              </p>
              <div className="flex justify-center gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 flex-1"
                >
                  Sim, Excluir
                </button>
              </div>
